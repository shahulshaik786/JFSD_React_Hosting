...
export default function Show(){
    ...
    function Deletefun (email) {
        axios.delete("https://jfsdspringhosting-production.up.railway.app/delete", {params:{
            email: email
        }}).then((res)=>{
            alert(res.data);
            setResult(null)
    ...
    function saveEdit() {
        axios.put("https://jfsdspringhosting-production.up.railway.app/update", {
    ...
    if(result == null) {
        axios.get("https://jfsdspringhosting-production.up.railway.app/all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
